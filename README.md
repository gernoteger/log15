...
# log15 [![godoc reference](https://godoc.org/github.com/gernoteger/log15?status.png)](https://godoc.org/github.com/gernoteger/log15) [![Build Status](https://travis-ci.org/gernoteger/log15.svg?branch=master)](https://travis-ci.org/gernoteger/log15)
...
```go
import log "github.com/gernoteger/log15"
```
